            ...
            <ul className="flex flex-col flex-nowrap gap-4 list-none">
                <li>
                    <Link 
                        ...
                        className="" >
                        <FaGithub className="w-6 h-6 md:w-8 md:h-8 hover:scale-105 filter hover:text-accent transition-all" />
                    </Link>
                </li>
                <li>
                    <Link 
                        ...
                        rel="noopener noreferrer"
                        className="" >
                        <FaLinkedin className="w-6 h-6 md:w-8 md:h-8 filter hover:scale-105 hover:text-accent transition-all duration-200" />
                    </Link>
                </li>
                <li>
                    <Link 
                        ...
                        rel="noopener noreferrer"
                        className="" >
                        <FaEnvelope className="w-6 h-6 md:w-8 md:h-8 filter hover:scale-105 hover:text-accent transition-all duration-200" />
                    </Link>
                </li>
            </ul>
        </div>
