      ...
      <div className='h-full'>
        <div className={`
          ...
          ${showChat ? 
            ...
            :
            'pt-[30vh] flex-1 flex flex-col items-center justify-center text-center'
          }
          `}>
            <div className={`
              transition-all duration-700 ease-in-out
              ${ showChat ? 
                `text-container shrunk pt-[3vh] md:pt-[6vh] flex-shrink-0 relative inline-block pb-2 px-2 md:px-8 md:h-full`
              :
                `text-container relative inline-block pb-2 px-8 md:pb-4 md:px-24 lg:pb-4 lg:px-48`
              }`}>
